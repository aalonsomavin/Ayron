...
TOOL_DISPLAY: dict[str, tuple[str, SubtitleBuilder | None]] = {
    "list_tables": ("Listar tablas", lambda _: "YIVTOL · AyronOne"),
    ...
    "create_spreadsheet": ("Crear hoja de cálculo", lambda _: "Excel"),
    "update_spreadsheet": ("Actualizar hoja de cálculo", lambda _: "Excel"),
    "get_spreadsheet": ("Leer hoja de cálculo", None),
